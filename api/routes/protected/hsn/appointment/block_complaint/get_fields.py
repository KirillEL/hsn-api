...
from core.hsn.appointment.blocks.complaint.model import AppointmentComplaintBlockFieldsResponse
...
@block_complaint_router.get(
    "/fields",
    response_model=list[AppointmentComplaintBlockFieldsResponse],
