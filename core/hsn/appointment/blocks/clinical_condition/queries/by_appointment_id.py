...
async def hsn_query_block_clinical_condition_by_appointment_id(
    ...
    if appointment.doctor_id != doctor_id:
        raise ForbiddenException(
            message="У вас нет прав для доступа к приему с id: {}".format(
                appointment_id
            )
        )
    ...
    query_get_block: Select = select(AppointmentClinicalConditionBlockDBModel).where(
    ...
    block_clinical_condition: AppointmentClinicalConditionBlockDBModel = (
