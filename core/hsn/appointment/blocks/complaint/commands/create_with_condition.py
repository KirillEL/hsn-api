...
async def hsn_block_complaint_and_clinical_condition_create(
    ...
    cursor = await session.execute(query_insert_block_complaint)
    ...
    cursor = await session.execute(query_insert_block_clinical_condidtion)
