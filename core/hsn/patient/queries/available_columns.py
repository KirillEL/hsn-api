...
async def hsn_query_patient_available_columns():
    available_patient_columns = [
        ...
        {'title': 'Направившая мед. организация', 'value': 'referring_clinic_organization'},
        ...
        {'title': 'Дата последней госпитализации', 'value': 'last_hospitalization_date'}
    ]
    response = [PatientAvailableColumnsResponse(**col) for col in available_patient_columns]
    return response
