...
def extract_clinic_doctor_info(block):
    return [
        block.reffering_doctor,
        block.reffering_clinic_organization,
        block.disability,
        block.lgota_drugs,
        block.has_hospitalization,
        block.count_hospitalization,
...
def extract_diagnose_info(block):
    return [
        block.diagnose,
        block.classification_func_classes,
        block.classification_adjacent_release,
        block.classification_nc_stage,
        block.cardiomyopathy,
        block.cardiomyopathy_note,
        block.ibc_pikc,
        block.ibc_pikc_note,
    ]
...
def extract_laboratory_test_info(block: AppointmentLaboratoryTestBlock):
    return [
        ...
        block.kaliy,
        block.glukoza,
        block.mochevaya_kislota,
        block.skf,
        block.kreatinin,
        block.bk_date,
        block.protein,
        block.urine_eritrocit,
        block.urine_leycocit,
        block.microalbumuria,
        block.am_date,
        block.note,
    ]
...
def extract_complaint_info(block: AppointmentComplaintBlock):
    return [
        ...
        block.has_dyspnea,
        block.increased_ad,
        block.rapid_heartbeat,
        block.has_swelling_legs,
        block.has_weakness,
        block.has_orthopnea,
        block.heart_problems,
        block.note,
    ]
...
def extract_block_clinical_condition_info(block: AppointmentClinicalConditionBlock):
    return [
        block.orthopnea,
        block.paroxysmal_nocturnal_dyspnea,
        block.reduced_exercise_tolerance,
        block.weakness_fatigue,
        block.peripheral_edema,
        block.ascites,
        block.hydrothorax,
        block.hydropericardium,
        block.night_cough,
        block.weight_gain_over_2kg,
        block.weight_loss,
        block.depression,
        block.third_heart_sound,
        block.apical_impulse_displacement_left,
        block.moist_rales_in_lungs,
        block.heart_murmurs,
        block.tachycardia,
        block.irregular_pulse,
        block.tachypnea,
        block.hepatomegaly,
        block.other_symptoms,
        block.height,
        block.weight,
        block.bmi,
        block.systolic_bp,
...
def extract_block_ekg_info(block: AppointmentEkgBlock):
    return [
        ...
        block.sinus_ritm,
        block.av_blokada,
        block.hypertrofia_lg,
        block.ritm_eks,
        block.av_uzlovaya_tahikardia,
        ...
        block.mgp,
        block.zslg,
        block.local_hypokines,
        block.difusal_hypokines,
        block.distol_disfunction,
        block.valvular_lesions,
        block.anevrizma,
        block.note,
    ]
