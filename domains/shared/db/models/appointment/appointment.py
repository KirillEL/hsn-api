...
from .. import UserDBModel, DoctorDBModel
...
class AppointmentDBModel(BaseDBModel):
    ...
    block_clinic_doctor = relationship(
        AppointmentBlockClinicDoctorDBModel, uselist=False
    )
    ...
    block_laboratory_test = relationship(
        AppointmentLaboratoryTestBlockDBModel, uselist=False
    )
    ...
    block_clinical_condition = relationship(
        AppointmentClinicalConditionBlockDBModel, uselist=False
    )
