...
from domains.core.hsn.patient.queries.get_table_columns import default_payload
from domains.shared.db.models.patient_columns import PatientTableColumnsDBModel
