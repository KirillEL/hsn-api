...
down_revision: Union[str, None] = '7872038b4a6f'
...
def downgrade() -> None:
    op.execute('drop trigger supplied_diagnose_updated_at_trg on public.supplied_diagnoses;')
    op.execute('drop trigger supplied_diagnose_deleted_at_trg on public.supplied_diagnoses;')
