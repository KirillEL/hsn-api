...
Revision ID: 35a2ddbc3653
Revises: 
Create Date: 2024-02-13 04:41:34.154248
...
def upgrade() -> None:
    ...
    sa.Column('mis_number', sa.BigInteger(), nullable=False),
    sa.Column('date_birth', sa.Date(), nullable=False),
    sa.Column('relative_phone_number', sa.BigInteger(), nullable=False),
    sa.Column('parent', sa.Text(), nullable=True),
    sa.Column('date_dead', sa.Date(), nullable=True),
    ...
    sa.Column('classification_func_classes', postgresql.ENUM('FK1', 'FK2', 'FK3', 'FK4', name='classification_func_classes'), nullable=True),
